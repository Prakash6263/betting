(function () {
  var srcs = ["https://cdn.jsdelivr.net/npm/chart.js","/assets/next/match-reports-inline-0.js","https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js","/assets/js/language.js?v=4","/assets/js/theme.js?v=1"];
  var i = 0;
  function next() {
    if (i >= srcs.length) {
